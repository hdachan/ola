...
//
// 분류는 "올라펫보험_QnA_분류_통합본" 문서의 대분류 체계를 그대로 따른다.
...
export interface FaqEntry {
  ...
  // 카테고리 안에서 한 번 더 묶어서 보여줄 소제목 (예: "가입 자격·대상").
...
export const faqEntries: FaqEntry[] = [
  ...
  // 기본 보장
  {
    ...
    answer: "보장담보(특약)은 포함되어 있으며 상해 및 질병치료비 (피부병, 구강질환, 슬고관절 탈구) 보장 반려동물 배상책임 (대인,대동물) 반려동물 사망시 위로금을 지급합니다. 치료를 받던 중 보험기간이 만료됐어요. 만료된 경우에도 만료일로부터 180일 이내 치료비는 보상합니다. 단 사고일 또는 발병일로부터 365일 이내의 치료인 경우엔 한합니다. (가입기간 1년)",
    category: "coverage",
    subgroup: "기본 보장",
  },
  {
