...
export const faqEntries: FaqEntry[] = [
  ...
  // 특장점 및 단일 상품
  {
    ...
    answer: "가장 큰 장점은 질병과 상해로 인한 입원,통원,수술 치료비를 횟수제한없이 사고당 7백만원 한도 내 연간 최대 3천만원 한도내에서 보장하는 점이예요. 또 피부,구강질환, 치료비 부담이 높은 슬개골,고관절 관련 질환까지 확장보장 해요. 반려동물로 인한 배상책임도 대인,대동물을 한 사고당 3천만원 한도내에서 보상합니다. 복잡한 특약을 포함하고 핵심보장을 균형있게 설계한 보험입니다.",
    category: "contract",
  ...
  },
  {
    ...
    answer: "올라는 이마트가 계약자로 DB손해보험과 계약하는 단체보험에 고객을 피보험자로 가입시키는 방식입니다. 쉽게 말하자면 좋은 조건으로 공동구매하는 방식입니다. 복잡한 특약을 포함시켰고 핵심보장을넓고 균형있게 설계한 보험입니다.",
    category: "contract",
    subgroup: "contract-strength",
  },
  {
