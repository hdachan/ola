...
export const faqEntries: FaqEntry[] = [
  ...
  // 특장점 및 단일 상품
  {
    ...
    answer: "가장 큰 장점은 질병과 상해로 인한 입원,통원,수술 치료비를 횟수제한없이 사고당 7백만원 한도 내 연간 최대 3천만원 한도내에서 보장하는 점이예요. 또 피부,구강질환, 치료비 부담이 높은 슬개골,고관절 관련 질환까지 확장보장 해요. 반려동물로 인한 배상책임도 대인,대동물을 한 사고당 3천만원 한도내에서 보상합니다. One플랜으로 복잡한 특약을 포함하고 핵심보장을 균형있게 설계한 보험입니다.",
    category: "contract",
  ...
  },
  {
    ...
    answer: "올라는 이마트가 계약자로 DB손해보험과 계약하는 단체보험에 고객을 피보험자로 가입시키는 방식입니다. 쉽게 말하자면 좋은 조건으로 공동구매하는 방식입니다. One플랜으로복잡한 특약을 포함시켰고 핵심보장을넓고 균형있게 설계한 보험입니다.",
    category: "contract",
    subgroup: "contract-strength",
  },
  {
    ...
    answer: "올라는 몰리스가 복잡하지 않게 특약을 포함해 핵심보장을 균형있게 설계한 One플랜 단일 상품이고 품종 및 나이 등에 따라 보험료가 산출됩니다.",
    category: "contract",
    subgroup: "contract-strength",
  },
  // 가입 자격·대상
  ...
  // 보장 개시·대기기간
  {
    ...
    answer: "계약을 맺을 때 보험사고가 이미 발생한 경우 계약은 무효예요. 또한 최초계약의 보험개시일 이전에 이미 감염 또는 발병한 질병·상해는 보상하지 않아요. (이 경우 3개월이내 진찰받은 이력이 있으면 3개월 이후 가입하면 됨. 단 만성질환으로 약을 복용중이면 가입이 어려움. 가입 후 상해는 즉시, 슬개골 고관절 90일, 다른 질병은 대기기간 30일)",
    category: "contract",
  ...
  },
  {
    id: "faq-coverage-03",
    question: "상해란 무엇인가요?",
    answer: "보험기간 중에 발생한 급격하고도 우연한 외래의 사고로 반려동물이 입은 상해를 말하며, 유독 가스 또는 유독 물질을 반려동물이 우연히 일시적으로 흡입, 흡수 또는 섭취한 결과로 생긴 중독 증상을 포함합니다. (그러나 음식물 섭취로 인한 증상, 세균성 음식물 중독과 상습적으로 흡입, 흡수 또는 섭취한 결과로 생긴 중독 증상은 포함되지 않습니다.)",
    category: "coverage",
    subgroup: "coverage-basic",
  },
  {
  ...
  // 기존 질병·고지 의무
  {
    ...
    answer: "치료 이력 자체가 가입 거절 사유는 아니에요. 사실대로 고지하면 돼요 가입조건 확인에서 질병은 3개월 이내, 비뇨기과 질환은 6개월 이내, 이력이 없으면 되고,  슬개골,고관절 관련의 경우 치료 이력이 과거부터 현재까지 없어야 가능해요.",
    category: "exclusion",
  ...
  },
  {
    ...
    answer: "현재는 연납만 가능하나 (자동차보험처럼) 카드 할부 12개월까지 가능하고 무이자 할부는 5개월가지 가능합니다.",
    category: "renewal",
    subgroup: "renewal-change",
  },
  {
  ...
  },
  {
    ...
    answer: "네. 해지시 비용 공제 후 경과하지 않은 기간에 대해 일단위로 계산한 보험료를 환급해요. (1년마다 재가입형 이라 청구이력이 있으면 해지 불가능)",
    category: "renewal",
    subgroup: "renewal-cancel",
  },
  {
    ...
    answer: "네. 계약자 책임있는 사유로 해지하는 경우 이미 경과한 기간에 대해 단기요율로 계산한 보험료를 공제한 잔액을 환급해요. 경과기간이 길수록 환급금이 적어져요. (1년마다 재가입형 이라 청구이력이 있으면 해지 불가능)",
    category: "renewal",
    subgroup: "renewal-cancel",
  },
  {
  ...
  // ════════════════════════════════════════════════════
  {
    ...
    answer: "펫보험은  예기치 못한 큰 질병이나 사고로 인한 고액의 동물병원비 부담을 줄여주는  전망입니다. 특히 반려동물이 나이가 들면서 의료비 지출이 크게 증가하므로,  목돈 마련이 부담스럽다면 가입하는 것이  유리합니다",
    category: "general",
  },
  {
    id: "faq-general-02",
    question: "반려동물 의료비가 평균적으로 얼마나 드나요?",
    answer: "반려동물 의료비는 병원 방문 시 평균 약 15만 원이 지출되며, 최근 2년간 반려가구에서 지출한 치료비는 평균 102만 원을 웃돕니다. 질환의 종류(예: 슬개골 탈구, 이물 섭취 등)에 따라 적게는 수십만 원에서 많게는 수백만 원까지 큰 차이가 날 수 있습니다. 동물병원 진료비는 병원마다 자율적으로 책정되기 때문에 동일한 진료 항목이라도 가격 차이가 발생할 수 있습니다.",
    category: "general",
  },
  {
    id: "faq-general-03",
    question: "보험사 별로 보장내용이 많이 다른가요?",
    answer: "펫보험은 보험사별로 보험료와 보장 내용(보장범위,보장비율, 자기부담금, 특약,면책기간 등)이 천차만별로 다릅니다.",
    category: "general",
  },
  {
    id: "faq-general-04",
    question: "보험사를 선택할 때 어떤 점을 가장 중요하게 봐야 하나요?",
    answer: "보장범위와 상품경쟁력을 통해 자신의 반려동물에 적합한 보험을 골라야 합니다.",
    category: "general",
  },
  {
    id: "faq-general-05",
    question: "연말정산에서 펫보험료를 공제 받을 수 있나요?",
    answer: "펫보험료는 연말정산 시 보험료 소득공제 대상에 포함되지 않습니다. 이는 보험료 세액공제가 근로자 본인 또는 기본공제 대상자를 위해 지출한 보장성 보험료에 대해 적용되는 원칙 때문입니다. 현행 세법상 반려동물은 법적으로 '부양가족'으로 인정되지 않으므로, 펫보험의 피보험자가 반려동물인 경우 보험료 세액공제 대상에서 제외됩니다.",
    category: "general",
  },
    {
    id: "faq-general-07",
