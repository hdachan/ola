...
export const faqCategories: FaqCategoryInfo[] = [
  ...
  { id: "payout", label: "F.보상 금액·지급" },
  { id: "claim", label: "E.보험금 청구" },

    { id: "exclusion", label: "D.면책·제외" },
...
export const faqSubgroups: FaqSubgroupInfo[] = [
  ...
  { id: "payout-limit", category: "payout", code: "F-1", label: "보상 한도·구조" },
  { id: "payout-method", category: "payout", code: "F-2", label: "지급 방식·지연" },
  { id: "payout-denial", category: "payout", code: "F-3", label: "보험금 지급 거절" },
  ...
  { id: "exclusion-period", category: "exclusion", code: "D-1", label: "면책기간" },
  { id: "exclusion-congenital", category: "exclusion", code: "D-2", label: "선천성·유전성 질환" },
  { id: "exclusion-preexisting", category: "exclusion", code: "D-3", label: "기존 질병·고지 의무" },
  { id: "exclusion-other", category: "exclusion", code: "D-4", label: "기타 면책 사유" },
...
export interface FaqEntry {
  ...
  // 카테고리 안에서 한 번 더 묶어서 보여줄 소제목 id. faqSubgroups에서 실제 코드/이름을 찾아 쓴다.
  // 같은 subgroup 값을 가진 항목들이 화면에서 연속으로 나올 때만 그 위에 소제목이 한 번 표시된다.
...
export const faqEntries: FaqEntry[] = [
  ...
  {
    id: "faq-contract-01",
    question: "1. 올라펫보험이 다른 보험과 다른 특장점이 뭔가요?",
  ...
  {
    id: "faq-contract-02",
    question: "2. 일반 DB손해보험의 펫보험과 다른 점이 뭔가요?",
  ...
  {
    id: "faq-contract-10",
    question: "1. 이미 아픈 상태인데 가입이 가능한가요?",
  ...
  {
    id: "faq-contract-12",
    question: "3. 동물병원에 최근 3개월이내 다녀왔는데 가입이 가능한가요?",
  ...
  {
    id: "faq-contract-13",
    question: "4. 갱신 계약할때도 대기기간 (면책기간)이 적용되나요?",
  ...
  {
    id: "faq-contract-14",
    question: "5. 가입 당일 사고가 나도 보장이 되나요?",
  ...
  {
    id: "faq-contract-15",
    question: "6. 치과질환, 구강질환, 피부병 질환 등 특약의 대기기간은?",
  ...
  {
    id: "faq-contract-16",
    question: "1. 가입 후 마음이 바뀌었는데 취소할 수 있나요?",
  ...
  {
    id: "faq-contract-18",
    question: "3. 철회 시 보험료는 전액 돌려받을 수 있나요?",
  ...
  {
    id: "faq-contract-19",
    question: "4. 보험증권을 받기 전에도 철회할 수 있나요?",
  ...
  {
    id: "faq-contract-20",
    question: "5. 철회 기간이 지난 경우에 계약을 취소할 수 있는 방법이 있나요?",
  ...
  {
    id: "faq-premium-01",
    question: "1. 고령견 가입시 너무 보험료가 비싸요?",
  ...
  {
    id: "faq-premium-07",
    question: "1. 1년 후 갱신시 보험료가 달라지나요?",
  ...
  {
    id: "faq-premium-08",
    question: "2. 갱신할 때마다 보험료가 오른다는데, 얼마나 오르나요?",
  ...
  {
    id: "faq-coverage-01",
    question: "1. 특약은 따로 가입하나요? 특약이 뭐예요?",
  ...
  {
    id: "faq-coverage-04",
    question: "4. 마취비, 처치비, 주사비 같은 항목도 보장되나요?",
  ...
  {
    id: "faq-coverage-06",
    question: "6. MRI·CT·초음파·혈액검사 같은 검사비도 보장되나요?",
  ...
  {
    id: "faq-coverage-07",
    question: "7. 응급 치료비·야간 진료비도 보장되나요?",
  ...
  {
    id: "faq-coverage-08",
    question: "8. 어떤 동물병원에서 치료를 받아도 보장이 되나요?수의사법 시행령 제13조에 따른 동물",
    ...
    question: "9. 치료를 받던 중 보험기간이 만료됐어요.",
  ...
  {
    id: "faq-coverage-16",
    question: "8. 수술은 모든 종류의 수술이 보장되나요?",
  ...
  {
    id: "faq-coverage-17",
    question: "9. 해외 동물병원에서 치료를 받으면 보장이 안 되나요?",
  ...
  {
    id: "faq-payout-01",
    question: "1. 통원과 입원의 보장 방식이 다른가요?",
  ...
  {
    id: "faq-payout-02",
    question: "2. 입원 기간 동안 매일 보장받을 수 있나요?",
  ...
  {
    id: "faq-payout-03",
    question: "3. 보상한도액이 어떤 식으로 적용되나요?",
  ...
  {
    id: "faq-payout-04",
    question: "4. 사고당 한도와 연간 한도 중 어느 게 먼저 적용되나요?",
  ...
  {
    id: "faq-payout-05",
    question: "5. 통원, 입원, 수술에 각각 별도 한도가 있나요?",
  ...
  {
    id: "faq-payout-06",
    question: "6. 보상비율 70%라고 하면, 나머지 30%는 제가 부담하는 건가요?",
  ...
  {
    id: "faq-payout-09",
    question: "9. 치료비가 자기부담금보다 적을 때도 보험금을 받을 수 있나요?",
  ...
  {
    id: "faq-payout-10",
    question: "10. 같은 질병으로 여러 번 치료받으면 한도가 합산되나요?",
  ...
  {
    id: "faq-payout-11",
    question: "11. 보험기간이 끝나기 직전에 아프기 시작했는데 만기 이후 치료비도 보장되나요?",
  ...
  {
    id: "faq-payout-13",
    question: "2. 보험금은 어느 계좌로 받을 수 있나요?",
  ...
  {
    id: "faq-payout-14",
    question: "3. 계좌 정보를 변경하려면 어떻게 해야 하나요?",
    answer: "",
    category: "payout",
    subgroup: "payout-method",
  },
  {
    id: "faq-payout-15",
    question: "4. 보험금이 예정일보다 늦게 지급되면 이자가 붙나요?",
  ...
  {
    id: "faq-payout-16",
    question: "5. 보험금 가지급 제도가 있다고 하는데 어떻게 신청하나요?",
  ...
  {
    id: "faq-payout-17",
    question: "6. 중복 보험에 가입한 경우 보험금을 두 곳에서 다 받을 수 있나요?",
  ...
  {
    id: "faq-payout-18",
    question: "7. 중복 보험인 경우 어떤 기준으로 나눠서 지급하나요?",
  ...
  {
    id: "faq-payout-19",
    question: "1. 과잉진료로 판단되면 보장을 안 해준다는 게 어떤 기준인가요?",
  ...
  {
    id: "faq-payout-20",
    question: "2. 보험금 지급이 거절됐을 때 이유를 알 수 있나요?",
  ...
  {
    id: "faq-payout-21",
    question: "3. 지급 거절 사유에 동의하지 않으면 어떻게 할 수 있나요?",
  ...
  {
    id: "faq-payout-22",
    question: "4. 진단명이 약관의 면책 항목에 해당한다고 하는데, 의사 소견은 다를 경우 어떻게 하나요?",
  ...
  {
    id: "faq-claim-02",
    question: "2. 하나의 사고로 여러번 병원에 다녀온 경우",
  ...
  {
    id: "faq-claim-03",
    question: "3. 같은 질병으로 계속 청구 가능한가요?",
  ...
  {
    id: "faq-claim-05",
    question: "5. 보험금 청구는 치료받은 당일에도 할 수 있나요?",
  ...
  {
    id: "faq-claim-06",
    question: "6. 오래전 치료비를 지금 청구해도 되나요? 청구 기한이 있나요?",
  ...
  {
    id: "faq-claim-07",
    question: "7. 진료비 영수증을 잃어버렸을 때 어떻게 하나요?",
  ...
  {
    id: "faq-claim-08",
    question: "8. 소액(1~2만원 정도)도 청구할 수 있나요?",
  ...
  {
    id: "faq-claim-09",
    question: "9. 동일 질병으로 여러 병원을 다녔을 때 통합해서 청구하나요?",
  ...
  {
    id: "faq-claim-10",
    question: "1. 보험료 청구 및 사고 접수는 어떻게 하나요?",
  ...
  {
    id: "faq-claim-13",
    question: "4. 가족 중 다른 사람이 청구해도 되나요?",
  ...
  {
    id: "faq-claim-14",
    question: "1. 가입 완료 후 보험증권은 어떻게 받을 수 있나요?",
  ...
  {
    id: "faq-claim-15",
    question: "2. 가입 완료 후 보험증권은 언제, 어떻게 받을 수 있나요?",
  ...
  {
    id: "faq-claim-16",
    question: "3. 보험금 청구에 필요한 서류가 무엇인가요?",
  ...
  {
    id: "faq-claim-17",
    question: "4. 영수증만 있으면 청구가 되나요, 진단서도 꼭 필요한가요?",
  ...
  {
    id: "faq-claim-18",
    question: "5. MRI·CT를 찍은 경우 영상 사진도 제출해야 하나요?",
  ...
  {
    id: "faq-claim-19",
    question: "1. 청구하면 보험금을 받기까지 얼마나 걸리나요?",
  ...
  {
    id: "faq-claim-20",
    question: "2. 청구 후 추가 서류를 요청받았는데 이유가 무엇인가요?",
  ...
  {
    id: "faq-claim-21",
    question: "3. 보험사에서 조사를 나온다고 하는데 어떤 경우에 조사가 진행되나요?",
  ...
  {
    id: "faq-claim-22",
    question: "4. 보험사 조사에 협조 안 하면 어떻게 되나요?",
  ...
  {
    id: "faq-claim-23",
    question: "5. 청구가 자주 많으면 거절당하기 쉬워지나요?",
  ...
  {
    id: "faq-claim-24",
    question: "6. 청구 결과가 마음에 안 들 때 이의 신청을 할 수 있나요?",
  ...
  {
    id: "faq-exclusion-02",
    question: "1. 대기기간 중에 사고가 나면 어떻게 처리되나요?",
  ...
  {
    id: "faq-exclusion-04",
    question: "3. 중성화 수술 비용은 왜 보장이 안 되나요?",
  ...
  {
    id: "faq-exclusion-05",
    question: "4. 건강검진 비용은 완전히 보장이 안 되나요?",
  ...
  {
    id: "faq-exclusion-06",
    question: "5. 미용(목욕, 그루밍 등) 비용은 당연히 안 되는 건가요?",
  ...
  {
    id: "faq-exclusion-07",
    question: "6. 임신·출산 관련 비용은 하나도 보장이 안 되나요?",
  ...
  {
    id: "faq-exclusion-08",
    question: "7. 건강동물에 실시하는 외과수술 및 기타 검사는 안되요",
  ...
  {
    id: "faq-exclusion-09",
    question: "8.한방·아로마·대체 치료는 왜 보장이 안 되나요?",
  ...
  {
    id: "faq-exclusion-10",
    question: "9.수의사 자격이 없는 사람에게 치료받으면 왜 안 되나요?",
  ...
  {
    id: "faq-exclusion-11",
    question: "1. 선천성 질환이 있는 아이도 가입할 수 있나요?",
  ...
  {
    id: "faq-exclusion-12",
    question: "2. 가입 전에 치료 이력이 있으면 무조건 안 되나요?",
  ...
  {
    id: "faq-exclusion-13",
    question: "3. 가입 전 병원 이력을 솔직하게 말하지 않으면 어떻게 되나요?",
  ...
  {
    id: "faq-exclusion-14",
    question: "4. 고지 의무 위반이 되면 보험 계약이 취소되나요, 아니면 보험금만 안 주는 건가요?",
  ...
  {
    id: "faq-exclusion-15",
    question: "5. 가입 당시에는 몰랐던 기존 질환이 나중에 발견된 경우에는 어떻게 되나요?보험개시 이",
  ...
  {
    id: "faq-exclusion-16",
    question: "6. 나이를 잘못 알고 고지했는데 나중에 문제가 생기면 어떻게 되나요?",
  ...
  {
    id: "faq-exclusion-17",
    question: "7. 치료 이력이 3개월 이내라서 가입이 안 된다고 하는데, 그 기준이 어떻게 되나요?",
  ...
  {
    id: "faq-exclusion-18",
    question: "1. 음식물을 먹거나 삼켜서 병원에 다녀왔어요.",
  ...
  {
    id: "faq-exclusion-19",
    question: "2. 보호자가 고의로 반려동물을 다치게 한 경우는 당연히 보장이 안 되는 건가요?",
  ...
  {
    id: "faq-exclusion-20",
    question: "3. 전쟁, 자연재해로 인한 사고는 왜 보장이 안 되나요?",
  ...
  {
    id: "faq-exclusion-21",
    question: "4. 국가 명령에 의한 살처분의 경우에는 어떻게 되나요?",
  ...
  {
    id: "faq-exclusion-22",
    question: "5. 먹이를 제대로 안 줘서 발생한 질병은 보장이 안 된다는 게 어떤 경우를 말하나요?",
  ...
  {
    id: "faq-exclusion-23",
    question: "6. 광견병 예방접종을 안 해서 걸린 광견병은 보장이 안 되나요?",
  ...
  {
    id: "faq-exclusion-24",
    question: "7. 반려동물이 싸움(투견 등)을 하다 다쳤을 때도 보장이 안 되나요?",
  ...
  {
    id: "faq-renewal-01",
    question: "1. 보험이자동으로갱신된다고하는데,갱신거절을당할수도있나요?",
    answer: "",
    category: "renewal",
  ...
  {
    id: "faq-renewal-03",
    question: "3. 갱신시보험조건(보장내용)이바뀔수있나요?",
  ...
  {
    id: "faq-renewal-04",
    question: "4. 갱신 전에 미리 알려 주나요? 얼마나 전에 알려 주나요?",
    answer: "",
    category: "renewal",
    subgroup: "renewal-renew",
  },
  {
    id: "faq-renewal-05",
    question: "5. 갱신을 원하지 않으면 어떻게 해야 하나요?",
    answer: "",
    category: "renewal",
    subgroup: "renewal-renew",
  },
  {
    id: "faq-renewal-06",
    question: "6. 갱신일에 반려동물이 아픈 경우 갱신이 안될수도 있나요?",
  ...
  {
    id: "faq-renewal-07",
    question: "1. 이마트 몰리스가 이 보험을 없애면 어떻게 되나요?",
  ...
  {
    id: "faq-renewal-09",
    question: "3. 보험료납입방법(월납↔연납)을중간에바꿀수있나요?",
  ...
  {
    id: "faq-renewal-10",
    question: "4. 보험증권에 기재된 반려동물 정보가 잘못 됐을 때 어떻게수정하나요?",
  ...
  {
    id: "faq-renewal-12",
    question: "2. 중간에 해지하면 환급금을 받을수있나요?",
  ...
  {
    id: "faq-renewal-13",
    question: "3. 해지시 환급금이 납입한 보험료보다 적을수있나요?",
  ...
  {
    id: "faq-renewal-14",
    question: "4. 반려동물이 사망한 경우 보험계약은 어떻게되나요?",
  ...
  {
    id: "faq-renewal-15",
    question: "5. 반려동물을 분양보낸(양도한) 경우 계약은 어떻게 되나요?",
  ...
  {
    id: "faq-renewal-16",
    question: "6. 보험을 해지했다가 나중에 다시 살릴수있나요?",
  ...
  // ════════════════════════════════════════════════════
  {
    ...
    question: "1. 동물등록이 안 된 반려동물도 보험에 가입할 수 있나요?",
    answer: "",
    category: "registration",
  },
  {
    id: "faq-registration-02",
    question: "2. 코사진(비문)으로 개체를 식별한다는 건 어떤원리인가요?",
    answer: "",
    category: "registration",
  },
  {
    id: "faq-registration-03",
    question: "3. 비문등록을 해두면 어떤 이점이 있나요?",
    answer: "",
    category: "registration",
  },
  {
    id: "faq-registration-04",
    question: "4. 보험에 가입한 반려동물과 치료받은 반려동물이 다른지 어떻게 확인하나요?",
    answer: "동물등록번호 등을 통해 동일성을 확인해요. 불일치시 추가 서류 제출이 요구될 수 있어요",
    category: "registration",
  },
  {
    id: "faq-registration-05",
    question: "5. 반려동물이 잃어버렸다가 다시 찾았는데 보험은 유효한가요?",
    answer: "분실자체가 계약종료 사유는 아니에요. 보험기간내 보험사고 발생시 보장됩니다. 다만 분실기간 중 사고관련 동일성 입증은 필요해요.",
    category: "registration",
  },
  {
    id: "faq-registration-06",
    question: "6. 반려동물의 나이를 확인할 방법이 없을 때 보험사에서 어떻게 처리하나요?",
    answer: "",
    category: "registration",
  },
  ...
  {
    id: "faq-general-01",
    question: "1. 펫보험이정말필요한가요?",
    answer: "",
    category: "general",
  },
  {
    id: "faq-general-02",
    question: "2. 반려동물 의료비가 평균적으로 얼마나 드나요?",
    answer: "",
    category: "general",
  },
  {
    id: "faq-general-03",
    question: "3. 보험사 별로 보장내용이 많이 다른가요?",
    answer: "",
    category: "general",
  },
  {
    id: "faq-general-04",
    question: "4. 보험사를 선택할 때 어떤 점을 가장 중요하게 봐야 하나요?",
    answer: "",
    category: "general",
  },
  {
    id: "faq-general-05",
    question: "5. 연말정산에서 펫보험료를 공제 받을 수 있나요?",
    answer: "",
    category: "general",
  },
  {
    id: "faq-general-06",
    question: "6. 예금자 보호법 보호대상",
