...
export const faqCategories: FaqCategoryInfo[] = [
  { id: "contract", label: "가입·계약" },
  { id: "premium", label: "보험료" },
  { id: "coverage", label: "보장 범위" },
  { id: "exclusion", label: "면책·제외" },
  { id: "claim", label: "보험금 청구" },
  { id: "payout", label: "보상 금액·지급" },
  { id: "renewal", label: "갱신·해지·계약 변경" },
  { id: "dispute", label: "불만·분쟁·민원" },
  { id: "registration", label: "반려동물 등록·신원 확인" },
  { id: "general", label: "기타·일반" },
];
...
export const faqEntries: FaqEntry[] = [
  ...
  {
    id: "faq-renewal-04",
    question: "갱신전에미리알려주나요?얼마나전에알려주나요?",
    answer: "",
    category: "renewal",
    subgroup: "renewal-renew",
  },
  ...
  {
    id: "faq-renewal-06",
    question: "갱신일에 반려동물이 아픈 경우 갱신이 안될수도있나요?",
  ...
  {
    id: "faq-general-03",
    question: "보험사별로보장내용이많이다른가요?",
    answer: "",
    category: "general",
  },
  {
    id: "faq-general-04",
    question: "보험사를 선택할 때 어떤점을 가장 중요하게 봐야 하나요?",
    answer: "",
    category: "general",
  },
  {
    id: "faq-general-05",
    question: "연말정산에서 펫보험료를 공제 받을수있나요?",
    answer: "",
    category: "general",
  },
  {
